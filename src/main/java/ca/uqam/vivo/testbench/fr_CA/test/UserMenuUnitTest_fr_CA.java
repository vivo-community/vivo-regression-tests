...
public class UserMenuUnitTest_fr_CA extends UserMenuUnitTest {
    private static final Log log = LogFactory.getLog(UserMenuUnitTest_fr_CA.class);
    @BeforeClass
    ...
    @DataProvider
    public Object[][] dp() {
        return UserMenuUnitTest.dp_fr_CA();
    } 
}